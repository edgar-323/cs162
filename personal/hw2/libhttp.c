...
char *http_get_mime_type(char *file_name) {
  ...
  if (file_extension == NULL) {
    return malloc_string("text/plain");
  }

  if (strcmp(file_extension, ".html") == 0 || strcmp(file_extension, ".htm") == 0) {
    return malloc_string("text/html");
  } else if (strcmp(file_extension, ".jpg") == 0 || strcmp(file_extension, ".jpeg") == 0) {
    return malloc_string("image/jpeg");
  } else if (strcmp(file_extension, ".png") == 0) {
    return malloc_string("image/png");
  } else if (strcmp(file_extension, ".css") == 0) {
    return malloc_string("text/css");
  } else if (strcmp(file_extension, ".js") == 0) {
    return malloc_string("application/javascript");
  } else if (strcmp(file_extension, ".pdf") == 0) {
    return malloc_string("application/pdf");
  } else {
    return malloc_string("text/plain");
  }
}
